    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="<?php echo e(url('categories/'.$category->id)); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id" id="" value="<?php echo e($category->id); ?>">
                    <?php echo method_field('put'); ?>
                    <div class="flex flex-wrap">
                        <label for="name" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            <?php echo app('translator')->get('general.name'); ?>:
                        </label>
...
unset($__errorArgs, $__bag); ?>"
                            name="name" value="<?php echo e(old('name', $category->name)); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="image"
                            value="<?php echo e(old('image')); ?>" accept="images/*">
...
unset($__errorArgs, $__bag); ?>" name="description"
                            value="<?php echo e(old('description', $category->description)); ?>" required autocomplete="description">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Maria Gamer\Desktop\larapp\resources\views/categories/edit.blade.php ENDPATH**/ ?>