        ...
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    action="<?php echo e(url('users/'.$user->id)); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id" id="" value="<?php echo e($user->id); ?>">
                    <?php echo method_field('put'); ?>
                    <div class="flex flex-wrap">
                        <label for="fullname" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            <?php echo app('translator')->get('general.label-fname'); ?>:
                        </label>

                        <input id="fullname" type="text" class="form-input w-full <?php $__errorArgs = ['fullname'];
...
unset($__errorArgs, $__bag); ?>"
                            name="fullname" value="<?php echo e(old('fullname', $user->fullname)); ?>" required autocomplete="fullname" autofocus>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        <label for="email" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            <?php echo app('translator')->get('general.label-email'); ?>:
                        </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        <label for="phone" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            <?php echo app('translator')->get('general.label-phone'); ?>:
                        </label>
...
unset($__errorArgs, $__bag); ?>" name="phone"
                            value="<?php echo e(old('phone', $user->phone)); ?>" required autocomplete="phone">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        <label for="birthday" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            <?php echo app('translator')->get('general.label-bdate'); ?>:
                        </label>

                        <input id="birthday" type="date"
                            class="form-input w-full <?php $__errorArgs = ['birthday'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="birthday"
                            value="<?php echo e(old('birthday', $user->birthday)); ?>" required autocomplete="birthday">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        <label for="gender" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                             <?php echo app('translator')->get('general.label-gender'); ?>:
                        </label>
                        
                        <select name="gender" id="gender" class="form-select w-full <?php $__errorArgs = ['gender'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="" <?php if(!old('gender', $user->gender)): ?> selected <?php endif; ?> disabled> <?php echo app('translator')->get('general.option-gender'); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        <label for="address" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                             <?php echo app('translator')->get('general.label-address'); ?>:
                        </label>

                        <input id="address" type="text"
                            class="form-input w-full <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="address"
                            value="<?php echo e(old('address', $user->address)); ?>" required autocomplete="address">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="photo" type="file"
                            class="hidden form-input w-full <?php $__errorArgs = ['photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="photo"
                            value="<?php echo e(old('photo')); ?>" accept="images/*">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <select name="role" id="role" class="form-select w-full <?php $__errorArgs = ['role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="" <?php if(!old('role', $user->role)): ?> selected <?php endif; ?> disabled>Select role...</option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <select name="active" id="active" class="form-select w-full <?php $__errorArgs = ['active'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="" <?php if(!old('active', $user->active)): ?> selected <?php endif; ?> disabled>Select active...</option>
                            <option value="1" <?php if(old('active', $user->active) == 1): ?> selected <?php endif; ?>>Active</option>
                            <option value="0" <?php if(old('active', $user->active) == 0): ?> selected <?php endif; ?>>Inactive</option>
                        </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Maria Gamer\Desktop\larapp\resources\views/users/edit.blade.php ENDPATH**/ ?>