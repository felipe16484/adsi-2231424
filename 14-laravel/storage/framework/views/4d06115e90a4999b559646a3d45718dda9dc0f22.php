...
unset($__errorArgs, $__bag); ?>"
                            name="fullname" value="<?php echo e(old('fullname')); ?>" required autocomplete="fullname" autofocus>
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="" <?php if(!old('gender')): ?> selected <?php endif; ?> disabled> <?php echo app('translator')->get('general.option-gender'); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap items-center justify-center bordered border-[1px] rounded-lg <?php $__errorArgs = ['photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        <img id="preview"  class="rounded-lg" src="<?php echo e(asset('images/no-photo.png')); ?>" width="200px">
                    </div>
...
unset($__errorArgs, $__bag); ?>" name="photo"
                            value="<?php echo e(old('photo')); ?>" accept="image/*" required>
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="" <?php if(!old('role')): ?> selected <?php endif; ?> disabled>Select role...</option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        <label for="password" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            <?php echo app('translator')->get('general.label-pass'); ?>:
                        </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-wrap">
                        <label for="password-confirm" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            <?php echo app('translator')->get('general.label-confirm'); ?>:
                        </label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SENA\Desktop\Larapp\resources\views/users/create.blade.php ENDPATH**/ ?>