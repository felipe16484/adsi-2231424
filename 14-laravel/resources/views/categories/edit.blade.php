    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ url('categories/'.$category->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <textarea id="description"
                            ...
                            required autocomplete="description">{{ old('description', $category->description) }}</textarea>
