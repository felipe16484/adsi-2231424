        ...
        <div class="w-full">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="flex flex-wrap items-center justify-center bordered border-[1px] rounded-lg @error('photo') border-red-500 @enderror">
